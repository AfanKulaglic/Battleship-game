...
export const Interviews = () => {
    ...
    const items: JSX.Element[] = [
      <div
        role="presentation"
        className="interviews-videos-card-col"
        style={{ backgroundImage: `url(${showcase})` }}
        key={1}
      >
        <div className="interviews-videos-content">
  ...
  return (
    <div className='interviews-video'>
        <h2 className='interviews-videos-title'>Interviews</h2>
        <AliceCarousel
            ref={carouselRef}
            mouseTracking
            items={items}
          ...
          />
          <div className="interviews-videos-controller">
